 ...
 * @author Usuario
 */
public class calculadoraIdade2 extends javax.swing.JFrame {

    /**
     * Creates new form calculadoraIdade2
     */
    public calculadoraIdade2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calculadoraIdade2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calculadoraIdade2().setVisible(true);
            }
        });
    }
